...
MODEL="coco_ssd_mobilenet_v1_1.0_quant_2018_06_29.zip"
...
curl -O "http://storage.googleapis.com/download.tensorflow.org/models/tflite/${MODEL}"
unzip -o ${MODEL} -d ${DATA_DIR}
rm ${MODEL}
...
mv ${DATA_DIR}/labelmap.txt ${DATA_DIR}/labels_original.txt
mv ${DATA_DIR}/coco_labels.txt ${DATA_DIR}/labels_corrected.txt
